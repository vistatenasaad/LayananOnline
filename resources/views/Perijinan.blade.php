...
<body id="page-top" class="bg-utama">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Perijinan</a>
            ...
            <a href="#">
                ...
                <!-- <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                               <br> <br> <br> <h4>Rencana Penggunaan Tenaga Kerja Asing</h4>
                            </div>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                            <br> <br> <br> <h4>Izin Menggunaan Tenaga Kerja Asing</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted"></p></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                            <br> <br> <br> <h4>Dana Kompensasi Penggunaan Orang Asing</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted"></p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                            <br> <br> <br> <h4>Visa Tinggal Terbatas</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted"></p></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                            <br> <br> <br> <h4>Kartu Izin Tinggal Tetap</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted"></p></div>
                        </div>
                    </li>
