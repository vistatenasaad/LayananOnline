...
<head>
    ...
    <!-- Title Page-->
    <title>Form Izin Menggunakan Tenaga Asing</title>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <br><br>
                    <h2 class="title">Pengajuan Surat Pengajuan Izin Menggunakan Tenaga Asing</h2>
                </div>
                <div class="card-body">
				...
				@endif
                    @csrf
                        ...
                        <div class="card-footer">
                             <!-- tambah detail-->
                            <a href="/PengajuanIMTA_sm/cetak_pdf/{{$details}}" class="bg-button" type="submit">Download pdf</a>
                        </div>
                        <div class="form-row">
