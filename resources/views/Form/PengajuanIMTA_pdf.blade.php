	...
	<table width="100%">
		...
		<tr>
			<td colspan="3">
				...
				<p>Nama: {{$pengajuan_imta['nama_lembaga']}} </p>
                <p>Whatsapp: {{$pengajuan_imta['whatsapp']}} </p>
                <p>Email: {{$pengajuan_imta['email']}} </p>
				<p>Jenis Layanan: Pengajuan Izin Menggunakan Tenaga Asing</p>
				<br>
				<h3>Berikut adalah Kode Tracking Status Pengajuan Surat Anda:</h3>
				<h3>{{$pengajuan_imta['id']}}</h3>
				</center>
			</td>
		</tr>
		<tr>
