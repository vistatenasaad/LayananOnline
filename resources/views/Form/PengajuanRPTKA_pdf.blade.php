	...
	<table width="100%">
		...
		<tr>
			<td colspan="3">
				...
				<p>Nama: {{$pengajuan_rptka['nama_lembaga']}} </p>
                <p>Whatsapp: {{$pengajuan_rptka['whatsapp']}} </p>
                <p>Email: {{$pengajuan_rptka['email']}} </p>
				<p>Jenis Layanan: Pengajuan Rencana Penggunaan Tenaga Kerja Asing</p>
				<br>
				<h3>Berikut adalah Kode Tracking Status Pengajuan Surat Anda:</h3>
				<h3>{{$pengajuan_rptka['id']}}</h3>
				</center>
			</td>
		</tr>
		<tr>
