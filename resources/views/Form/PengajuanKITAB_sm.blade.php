...
<head>
    ...
    <title>Form Kartu Izin Tingga Tetap</title>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <br><br>
                    <h2 class="title">Pengajuan Kartu Izin Tinggal Tetap</h2>
                </div>
                <div class="card-body">
				...
				@endif
                    @csrf
                        ...
                        <div class="card-footer">
                             <!-- tambah detail-->
                            <a href="/PengajuanKITAB_sm/cetak_pdf/{{$details}}" class="bg-button" type="submit">Download pdf</a>
                        </div>
                        <div class="form-row">
