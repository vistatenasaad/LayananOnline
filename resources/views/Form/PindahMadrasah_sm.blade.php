...
<head>
    ...
    <title>Pengajuan Rekomendasi Pindah Madrasah/ Sekolah</title>
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <br><br>
                    <h2 class="title">Pengajuan Rekomendasi Pindah Madrasah/ Sekolah</h2>
                </div>
                <div class="card-body">
				...
				@endif
                    @csrf
                        ...
                        <div class="card-footer">
                             <!-- tambah detail-->
                            <a href="/PindahMadrasah_sm/cetak_pdf/{{$details}}" class="bg-button" type="submit">Download pdf</a>
                        </div>
                        <div class="form-row">
