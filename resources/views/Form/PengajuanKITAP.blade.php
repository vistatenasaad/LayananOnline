				...
				@endif
                    ...
                    @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                            <div class="input-group js-input-file">
                                    <input type="file" name="file_paspor_kitas" placeholder="Choose file" id="file">
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                            <div class="input-group js-input-file">
                                    <input type="file" name="file_persetujuan_sebelumnya" placeholder="Choose file" id="file">
                                </div>
