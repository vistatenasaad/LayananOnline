...
<body id="page-top" class="bg-utama">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Pengesahan</a>
        ...
        <section class="page-section" id="about">
            ...
            <a href="/LegalisirIjazah">
                ...
                <!-- <div class="text-center">
                    <h2 class="section-heading text-uppercase">Pengesahan</h2>
                ...
                <!-- <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                              <br> <br> <br>  <h4>Legalisir Ijazah</h4>
                            </div>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                               <br> <br> <br> <h4>Tanda Tangan Sertifikat</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted"></p></div>
                        </div>
                    </li>
